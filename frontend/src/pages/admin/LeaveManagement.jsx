...
export default function AdminLeaveManagement() {
    ...
    const getRoleBadge = (role) => {
        ...
        return (
            <span className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full capitalize ${styles[role] || styles.employee}`}>
                {role}
            </span>
        )
    }
    ...
    return (
        <DashboardLayout>
            <div className="page-header">
                ...
                <p className="page-subtitle">Review and action all leave requests — including manager requests</p>
            </div>
            ...
            <div className="card p-4 sm:p-6">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100">
                        All Leave Requests <span className="text-xs text-gray-400 ml-1">({total})</span>
                    </h3>
                    {selected.length > 0 && (
                ...
                <div className="mb-4">
                    <SearchFilter value={search} onChange={(v) => { setSearch(v); setPage(1) }} placeholder="Search by employee or manager name...">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div>
                                                        <div className="flex items-center gap-1.5">
                                                            <p className="font-medium text-sm text-gray-900 dark:text-gray-100">{l.employee?.name}</p>
                                                            {getRoleBadge(l.employee?.role)}
                                                        </div>
            ...
            >
                <div className="space-y-4">
                    {reviewModal.leave && (
                        <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-xl text-sm">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                {getRoleBadge(reviewModal.leave.employee?.role)}
                            </div>
                    ...
                    <div>
                        ...
                        <textarea className="textarea" rows={3} placeholder="Add a note for the applicant..." value={reviewNote} onChange={(e) => setReviewNote(e.target.value)} />
                    </div>
                    <div className="flex gap-2">
